                ...
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="relative">
                    <button
                      disabled={loading}
                      type="submit"
                      className="bg-teal-800 text-white rounded-md px-2 py-1">
                      Continuă
                    </button>
                  </div>
                  {error && <span className='text-red-600'>{error}</span>} {/* Display error message if there is one */}
                </div>
              </div>
            </div>
            <Link to='/sign-in' className='text-teal-800 hover:underline'>Intră în cont</Link>
          </div>
        </form>
      </div>
    </div>
