...
export default function ProductModal({ open, onClose, product }) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className={`relative w-full md:w-3/4 lg:w-3/5 max-w-2xl max-h-[90vh] overflow-y-auto rounded-xl bg-white shadow-2xl transition-all duration-400 ease-in-out ${
